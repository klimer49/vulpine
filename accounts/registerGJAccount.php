...
if($smtp == true) {
    ...
    $mail->Subject = 'Your account registration on GDPS';
    $mail->Body    = "<h1>Hello, $userName</h1>
    <p>You have successfully registered on Vulpine GDPS</p>
    <p>You must finish your registration by going link under this text:</p>
