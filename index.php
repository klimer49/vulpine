...
if ($server_status == 0) {
    ...
    <body>
    <div class="main">
        <img src="https://media.discordapp.net/attachments/881485225627099146/916691053514469396/updlogo.png"
                ...
                <div class="services__card" id="connect">
                    ...
                    if ($mysql_status == 0) {
                        ...
                        <form method="post" id="mysql_form" action="">
                            <p class="center"><input id="mysql_hostname" name="mysql_hostname"
                                                     placeholder="MySQL hostname" required/></p>
                            <p class="center"><input id="mysql_username" name="mysql_username"
                                                     placeholder="MySQL username" required/></p>
                            <p class="center"><input id="mysql_password" name="mysql_password" type="password"
                                                     placeholder="MySQL password" required/></p>
                            <p class="center"><input id="mysql_database" name="mysql_database"
                                                     placeholder="MySQL database" required/></p>
                ...
                <div class="services__card">
                    ...
                    if ($reg_status == 0) {
                        ...
                        <form method="post" id="reg_form" action="">
                            <p class="center">E-mail verification: <input type="checkbox" id="reg_email"
                                                                          onclick="reg_email_a()"/></p>
                            <div id="reg_email_form">

                            </div>
                            <p class="center">Captcha: <input type="checkbox" id="reg_captcha"
                                                              onclick="reg_captcha_a()"/></p>
    ...
    <script>
        ...
        function reg_check() {
            ...
            let reg_captcha_secret, reg_captcha_public = "";
            if (reg_captcha) {
    ...
    if ($session_account_id == 0) {
        ...
        if ((new main)->isAdmin($session_account_id)) {
            exit("1");
        } else {
            exit("2");
        }
